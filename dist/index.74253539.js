...
})({"8Dscp":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "2169d88074253539";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./snake":"kYPqj"}],"gkKU3":[function(require,module,exports) {
...
},{}],"kYPqj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Snake {
    ...
    movesnake() {
        ...
        switch(this.actualDirection){
            case 't':
                if (actualHead.y > 0) this.snake[this.snake.length - 1] = {
                    x: actualHead.x,
                    y: actualHead.y - 1
                };
                break;
            case 'r':
                if (actualHead.x < _constant.TABLE_WIDTH - 1) this.snake[this.snake.length - 1] = {
                    x: actualHead.x + 1,
                    y: actualHead.y
                };
                break;
            case 'b':
                if (actualHead.y < _constant.TABLE_HEIGHT - 1) this.snake[this.snake.length - 1] = {
                    x: actualHead.x,
                    y: actualHead.y + 1
                };
                break;
            case 'l':
                if (actualHead.x > 0) this.snake[this.snake.length - 1] = {
                    x: actualHead.x - 1,
                    y: actualHead.y
                };
                break;
        ...
        const makeChain = (k = this.snake.length - 2, value = actualHead)=>{
            if (k < 0) return;
    ...
    updateDirection(d) {
        if (d === 't' && this.actualDirection === 'b' || d === 'b' && this.actualDirection === 't') return;
        if (d === 'l' && this.actualDirection === 'r' || d === 'r' && this.actualDirection === 'l') return;
    ...
    generatPosition(snake) {
        let newX = this.foodPosition.x;
        let newY = this.foodPosition.y;
        while(!(this.foodPosition.x !== newX || this.foodPosition.y !== newY) || snake.indexOf({
            x: newX,
            y: newY
        }) > 0){
            newX = getRandomInt(_constant.TABLE_WIDTH);
            newY = getRandomInt(_constant.TABLE_HEIGHT);
        }
        this.foodPosition = {
            x: newX,
            y: newY
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./constant":"2cbSq"}],"2cbSq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TABLE_WIDTH", ()=>TABLE_WIDTH
);
parcelHelpers.export(exports, "TABLE_HEIGHT", ()=>TABLE_HEIGHT
);
const TABLE_WIDTH = 30;
const TABLE_HEIGHT = 40;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8Dscp","192EZ"], "192EZ", "parcelRequire46ba")

//# sourceMappingURL=index.74253539.js.map
